...
export const ru: I18nDictionary = {
  ...
  "bot.event_stream_disconnected":
    "⚠️ Соединение с сервером OpenCode потеряно.\\n\\nПовторное подключение не удалось. Используйте /status для проверки сервера или /opencode_start для его перезапуска.",

  "health.server_unreachable":
    "🔴 Сервер OpenCode не отвечает.\\n\\nПроверка работоспособности несколько раз завершилась неудачей. Используйте /status для диагностики или /opencode_start для перезапуска.",
  "health.server_recovered": "✅ Сервер OpenCode снова работает.",
  ...
  "status.mcp.section": "MCP серверы ({count}):",
  "status.mcp.item_connected": "  ✅ {name}",
  "status.mcp.item_disabled": "  ⏸ {name} (отключён)",
  "status.mcp.item_needs_auth": "  🔑 {name} (требует авторизации)",
  "status.mcp.item_failed": "  ❌ {name}: {error}",
  "status.mcp.none": "MCP серверы: нет",
  "status.formatters.section": "Форматтеры ({count}):",
  "status.formatters.item": "  • {name} ({extensions})",
  "status.formatters.none": "Форматтеры: нет",
  ...
  "file_upload.queued":
    "📎 Файл добавлен в очередь: {filename}\\n\\nОтправьте сообщение, и я включу его как контекст для OpenCode.",
  "file_upload.download_error": "❌ Не удалось скачать файл. Попробуйте ещё раз.",
  ...
  "cmd.description.newproject": "Открыть директорию как проект",
  "cmd.description.ls": "Список файлов в директории проекта",
  "cmd.description.tree": "Дерево директорий проекта",

  "newproject.usage":
    "Использование: /newproject <путь>\n\nПример:\n`/newproject /home/user/my-project`\n\nОткрывает директорию как проект OpenCode и делает его активным.",
  "newproject.checking": "🔄 Открываю проект по пути: `{path}`...",
  "newproject.success":
    "✅ Проект открыт: **{project}**\n\nСессия сброшена. Используйте /sessions или /new для этого проекта.",
  "newproject.error":
    "🔴 Не удалось открыть проект по пути: `{path}`\n\nУбедитесь, что путь существует и сервер OpenCode запущен.",

  "ls.project_not_selected": "🏗 Проект не выбран.\n\nСначала выберите проект с /projects.",
  "ls.empty": "📭 Файлы не найдены по пути: `{path}`",
  "ls.header": "📂 **`{path}`**\n\n",
  "ls.item_dir": "📁 {name}/",
  "ls.item_file": "📄 {name}",
  "ls.item_ignored": "  _(игнорируется)_",
  "ls.more": "\n_...и ещё {count} файлов_",
  "ls.error": "🔴 Не удалось получить список файлов.\n\nУбедитесь, что путь существует.",
  "ls.not_found": "🔴 Путь не найден: `{path}`",

  "tree.project_not_selected": "🏗 Проект не выбран.\n\nСначала выберите проект с /projects.",
  "tree.header": "🌲 **Дерево: `{path}`**\n\n",
  "tree.empty": "📭 Файлы не найдены по пути: `{path}`",
  "tree.error": "🔴 Не удалось получить дерево директорий.\n\nУбедитесь, что путь существует.",

  "status.worktrees.section": "Worktrees ({count}):",
  "status.worktrees.item": "  🌿 {name} — `{branch}` (`{directory}`)",
  "status.worktrees.none": "Worktrees: нет",
  "status.vcs.branch": "Ветка: `{branch}`",
};
